...
static const float forwardSpeed = 0.4;
static const float angularSpeed = 0.4;
...
static const int childRadius = 4;
static const float childlYawRange = 15;
...
// Waypoints
static const unsigned short stdWaypntRadius = 4;
